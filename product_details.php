...
<head>
    ...
    <style>
        ...
        .product-title { font-weight: 800; font-size: 1.8rem; line-height: 1.3; word-wrap: break-word; color: #222; }
        .img-wrapper { background: var(--bg-light); border-radius: 15px; padding: 20px; text-align: center; }
        .img-wrapper img { max-width: 100%; height: auto; border-radius: 10px; transition: 0.3s; }
        ...
        .spec-table th { width: 35%; background-color: #f8f9fa; color: #555; font-size: 0.9rem; padding: 12px; }
        .spec-table td { font-size: 0.9rem; padding: 12px; font-weight: 500; }
        .btn-buy { padding: 15px; font-weight: 800; border-radius: 50px; text-transform: uppercase; transition: 0.3s; }
        .btn-buy:hover { transform: translateY(-3px); box-shadow: 0 5px 15px rgba(215,0,24,0.3); }
        .review-item { background: #fff; border-radius: 12px; padding: 20px; margin-bottom: 15px; border: 1px solid #eee; transition: 0.3s; }
        .review-item:hover { border-color: var(--primary-orange); box-shadow: 0 5px 15px rgba(0,0,0,0.05); }
    </style>
</head>
<body>
...
<nav class="navbar navbar-expand-lg navbar-light shadow-sm sticky-top">
    <div class="container">
        ...
        <div class="ms-auto">
            <a href="view_cart.php" class="btn btn-dark btn-sm rounded-pill px-4">Giỏ hàng</a>
        </div>
    </div>
</nav>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-7">
                ...
                <div class="d-grid mt-4">
                    <a href="add_to_cart.php?id=<?= $products['product_id'] ?>" class="btn btn-danger btn-buy shadow">
...
<footer class="bg-dark text-white py-4 mt-5 text-center">
    <div class="container"><p class="mb-0 small opacity-75">© 2026 LAPTOP STORE - FIT TDC Project</p></div>
</footer>
