                        ...
                        <?php foreach ($orders as $row): ?>
                            <tr id="row-<?= $row['order_id'] ?>">
                                ...
                                <td class="customer-col">
                                    <div class="fw-bold text-truncate-custom" title="<?= htmlspecialchars($row['customer_name'] ?? 'Khách lẻ') ?>">
                                        <?php
                                        $name = $row['customer_name'] ?? 'Khách lẻ';
                                        // Cắt chuỗi nếu dài quá 15 ký tự (dùng mb_ để không lỗi font tiếng Việt)
                                        echo (mb_strlen($name) > 15) ? mb_substr($name, 0, 15) . '...' : $name;
                                        ?>
                                    </div>
